...
def carregar_dados():
    caminho = os.path.join(app.root_path, "data", "dados.json")
...
def rotas():
    dados = carregar_dados()
    return render_template("rotas.html", rotas=dados["rotas_detalhadas"])

@app.route("/despesas")
def despesas():
    dados = carregar_dados()
    return render_template("despesas.html", despesas=dados["despesas"])
